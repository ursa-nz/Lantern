...
# Lantern's own theme. Assigning a font generates this CSS (a thin override of
# the built-in `default` theme) and points the deck's `theme:` directive at it.
...
def generate_theme(work_dir) -> None:
    """Write styles/lantern.css from the current font-role assignments."""
    work_dir = Path(work_dir)
